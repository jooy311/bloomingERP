				...
				<div class="container1">
					...
					<div class="row">
						...
						<div class="col-xs-6 col-md-4">
							<div class="fg-line form-group">
								<input type="text" class="form-control input-sm" placeholder="주문번호를 입력해주세요" name="poOrderNo" id="poOrderNo" required>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-xs-6 col-md-4">
							<div class="fg-line form-group">
								<input type="hidden" class="form-control input-sm" placeholder="사원번호를 입력해주세요" name="poEmpNo" id="poEmpNo" required>
					...
					<div class="row">
						...
						<div class="col-xs-6 col-md-4">
							<div class="fg-line form-group">
								<input type="hidden" class="form-control input-sm" placeholder="거래처코드를 입력해주세요" name="poCltNo" id="poCltNo" required>
								<input type="text" class="form-control input-sm" placeholder="거래처코드를 입력해주세요" name="viewPoCltNo" id="viewPoCltNo" required>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-xs-6 col-md-4">
							<div class="fg-line form-group">
								<input type="text" class="form-control input-sm" placeholder="발주상품을 입력해주세요" id="poProduct" name="poProduct" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-6 col-md-4">
							<div class="fg-line form-group">
								<input type="text" class="form-control input-sm" placeholder="발주수량을 입력해주세요" id="poCnt" name="poCnt" required>
							</div>
						</div>
					</div>
