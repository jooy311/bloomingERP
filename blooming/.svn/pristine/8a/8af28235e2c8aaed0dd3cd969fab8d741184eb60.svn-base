...
<div class="container">
			...
			<div class="col-sm-6 col-md-3">
				<div class="mini-charts-item bgm-cyan">
					<div class="clearfix">
						...
						<div class="count">
							<small>최고 매출</small> 
								<c:forEach var="sales" items="${weekMax}">
			...
			<div class="col-sm-6 col-md-3">
				<div class="mini-charts-item bgm-lightgreen">
					<div class="clearfix">
						...
						<div class="count">
							<small>최저 매출</small> 
								<c:forEach var="sales" items="${weekMin}">
								<small>(${sales.relout.relDate}일)</small>
								<h2 >
								<fmt:formatNumber type="number" maxFractionDigits="3" value="${sales.maxiSales}" />
								</h2>
			...
			<div class="col-sm-6 col-md-3">
				<div class="mini-charts-item bgm-orange">
					<div class="clearfix">
						...
						<div class="count">
							<small>총 매출</small>
								<small>(오늘으로 부터 7일 전 기준)</small>
								<c:forEach var="sales" items="${weekEntire}">
								<h2 >
				...
				<div class="mini-charts-item bgm-red">
					<div class="clearfix">
						...
						<div class="count">
							<small>평균 매출</small>
								<small>(오늘으로 부터 7일 전 기준)</small>
								<c:forEach var="sales" items="${weekAvg}">
								<h2 >
	...
	<div class="card">
		...
		<table id="data-table-command"
			...
			<tbody>
				<!-- 데이터 출력 -->
				<c:forEach var="sales" items="${weekList}">
					<tr>
